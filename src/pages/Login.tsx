...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (email && password) {
        ...
        toast({
          title: "Успішний вхід!",
          description: "Ласкаво просимо до кабінету лектора",
        });
        navigate('/dashboard');
      } else {
        toast({
  ...
  const handleGoogleLogin = () => {
    toast({
      title: "Google OAuth",
      description: "Функція буде додана пізніше",
    });
  };

  return (
    <div className="min-h-screen pt-16 bg-background flex items-center justify-center px-4">
      <Card className="w-full max-w-md card-gradient border-border shadow-soft">
        <CardHeader className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            Увійдіть до свого кабінету лектора
          </p>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="lecturer@docstream.ua"
                  value={email}
          ...
          <div className="text-center text-sm">
            <span className="text-muted-foreground">Немає аккаунта? </span>
